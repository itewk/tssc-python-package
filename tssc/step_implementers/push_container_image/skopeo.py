...
|--------------------------|------------------|------------
| `generate-metadata`      | `image-version`      | Tag to push image with
...
class Skopeo(StepImplementer):
    ...
    def _run_step(self):
        ...
        image_repository_uri = f"{self.get_config_value('destination-url')}/{organization}/{application_name}-{service_name}"
        ...
        results = {
            ...
            'container-image-repository-uri' : image_repository_uri,
